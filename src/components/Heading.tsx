  ...
  return (
    <div className='py-10'>
      <div className='flex justify-center '>
        <div className='flex flex-row justify-between w-3/4 sm:w-4/5 bg-violet-300  items-center shadow-gray-700 py-2 md:px-3 px-1 dark:bg-[#282A3A] shadow-md dark:shadow-slate-950'>
